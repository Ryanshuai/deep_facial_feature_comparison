...
dataset_length = len(y_label)
test_set_length = int(dataset_length * 0.2)
val_set_length = int(dataset_length * 0.1)
y_label = y_label[-(test_set_length + val_set_length):-val_set_length]
y_pred = y_pred[-(test_set_length + val_set_length):-val_set_length]
